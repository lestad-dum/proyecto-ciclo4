...
public class verificacion extends javax.swing.JFrame {
    ...
    /**
     * Creates new form regitrar_usuario
     */
    public verificacion() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setForeground(new java.awt.Color(238, 215, 215));
        ...
        jButton1.setBackground(new java.awt.Color(172, 52, 52));
        ...
        jButton2.setBackground(new java.awt.Color(178, 58, 58));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String nombreUsu = jTextField1.getText();
    ...
    boolean sesionIniciada = usuario.iniciarSesion(nombreUsu, contraseña);
    
    boolean rolvalidado = usuario.verificarPermisoAdmin();
    
       if (sesionIniciada && rolvalidado) {
              this.dispose();
