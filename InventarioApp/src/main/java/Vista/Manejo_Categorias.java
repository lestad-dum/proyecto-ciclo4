 ...
 * @author Usuario
 */
public class Manejo_Categorias extends javax.swing.JFrame {

    /**
     * Creates new form Manejo_Categorias
     */
    public Manejo_Categorias() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton4.setText("Actualizar o Emilinar Categoria");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Manejo_Categorias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Manejo_Categorias().setVisible(true);
            }
        });
    }
